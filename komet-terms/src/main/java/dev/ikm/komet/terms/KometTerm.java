...
public class KometTerm {
    ...
    public static final EntityProxy.Concept ALLOWED_STATES_FOR_STAMP_COORDINATE =
            EntityProxy.Concept.make("Allowed states for stamp coordinate (SOLOR)", java.util.UUID.fromString("23f69f6f-a502-5876-a835-2b1b4d5ce91e"));
    ...
    public static final EntityProxy.Concept MODULE_EXCLUSION_SET_FOR_STAMP_COORDINATE =
            EntityProxy.Concept.make("Module exclusion set for stamp coordinate (SOLOR)", java.util.UUID.fromString("3fe047f0-33b0-5254-91c2-43e65f90d30b"));
    ...
    public static final EntityProxy.Pattern CONCEPT_ASSEMBLAGE_FOR_LOGIC_COORDINATE =
            EntityProxy.Pattern.make("Concept assemblage for logic coordinate (SOLOR)", UUID.fromString("16486419-5d1c-574f-bde6-21910ad66f44"));
