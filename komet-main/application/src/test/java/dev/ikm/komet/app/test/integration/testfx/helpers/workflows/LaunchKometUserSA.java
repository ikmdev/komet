...
public class LaunchKometUserSA extends BaseWorkflow {
     ...
     */
    public LaunchKometUser(FxRobot robot, TestReporter reporter) {
     ...
     * @param robot FxRobot instance for UI interactions
     */
    public LaunchKometUser(FxRobot robot) {
        super(robot, null);
    }
     ...
     */
    public void launchKomet(String USERNAME, String PASSWORD) throws InterruptedException, java.util.concurrent.TimeoutException {
