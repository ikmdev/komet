...
public class AddDeviceCompanySemantic extends BaseWorkflow {

    /**
     * Constructs an AddDeviceCompanySemantic workflow helper.
     * 
     * @param robot    FxRobot instance for UI interactions
     * @param reporter TestReporter instance for logging test steps
     */
    public AddDeviceCompanySemantic(FxRobot robot, TestReporter reporter) {
     ...
     */
    public void addDeviceCompanySemantic(String patternName, String status,
        ...
        try {
            ...
            reporter.logFailure(
                    "Populate the Device Labeler/Associated Devices field by searching for device identifier(s)", e);
            throw e;
        }
