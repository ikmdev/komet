...
public class TestConfiguration {
    ...
    protected static final String USERNAME = credentialsReader.get("komet_username", "KOMET user");
    protected static final String PASSWORD = credentialsReader.get("komet_password", "KOMET user");
