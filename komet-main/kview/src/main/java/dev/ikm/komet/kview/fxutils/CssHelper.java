...
public class CssHelper {
    ...
    public static final String KVIEW_CSS_FILE = "../mvvm/view/kview.css";
    public static final String KVIEW_DEFAULT_CSS_FILE = KVIEW_CSS_FILE;

    public static String retrieveStyleSheet(String path, Class<?> clazz) {
        String cssFile = ResourceHelper.toAbsolutePath(path, clazz);
    ...
    public static String defaultStyleSheet() {
        ...
        String cssFile = ResourceHelper.toAbsolutePath(KVIEW_DEFAULT_CSS_FILE, clazz);
