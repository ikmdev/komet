...
public class ChangeFeatureOperator extends ChangeToConceptFromObjectAbstract {

    public ChangeFeatureOperator(String text, Object operator, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator, EditCoordinate editCoordinate) {
        super(text, operator, axiomSubjectRecord, viewCalculator, editCoordinate);
    }
    ...
    public void doAction(ActionEvent t, ConceptFacade conceptToChangeTo, AxiomSubjectRecord axiomSubjectRecord, EditCoordinateRecord editCoordinate) {
        ...
        switch (leb.get(axiomSubjectRecord.axiomIndex())) {
            case LogicalAxiom.Atom.TypedAtom.Feature featureAxiom -> {
                leb.updateFeatureOperator(featureAxiom, conceptToChangeTo);
            }
