...
public class RemoveFromKometBaseModelAction extends AbstractActionSuggested {
    ...
    public RemoveFromKometBaseModelAction(ConceptEntityVersion conceptVersion, ViewCalculator viewCalculator, EditCoordinate editCoordinate) {
        super("Remove from Komet base model", viewCalculator, editCoordinate);
