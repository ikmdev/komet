...
public class AddNecessarySet extends AbstractAxiomAction {
    public AddNecessarySet(String text, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator, EditCoordinate editCoordinate) {
