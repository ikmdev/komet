...
public class AddRoleGroup extends AbstractAxiomAction {
    private static final Logger LOG = LoggerFactory.getLogger(AddRoleGroup.class);

    public AddRoleGroup(String text, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator, EditCoordinate editCoordinate) {
