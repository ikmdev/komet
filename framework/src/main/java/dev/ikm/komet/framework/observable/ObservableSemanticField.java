...
public sealed class ObservableSemanticField<DT> implements Feature<DT>, Field<DT>, ObservableFeature
    ...
    public ObservableSemanticField(FeatureKey featureKey, Field<DT> attribute, ObservableComponent containingComponent, boolean writeOnEveryChange) {
    ...
    public ObservableSemanticField(FeatureKey featureKey, Field<DT> attribute, ObservableComponent containingComponent) {
    ...
    public abstract static sealed class Editable<DT>
        ...
        protected final ObservableSemanticField<DT> observableSemanticField;
         ...
         *
         * @param observableSemanticField the read-only feature to wrap
         ...
         */
        Editable(ObservableSemanticField<DT> observableSemanticField, DT initialValue, int featureIndex) {
            this.observableSemanticField = observableSemanticField;
         ...
         */
        public ObservableSemanticField<DT> getObservableFeature() {
            return observableSemanticField;
        }
         ...
         */
        public void reset() {
            editableValueProperty.set(observableSemanticField.value());
        }
