        ...
        try {
            if (property.getPropertyEditorClass().isPresent()) {
                ...
                if (editorClass == AxiomView.class) {
                    ...
                    int semanticNid = property.observableField.fieldRecord().semanticNid();
                    ObservableSemantic axiomSemantic = ObservableSemantic.get(semanticNid);
                    ObservableSemanticVersion axiomSemanticVersion = axiomSemantic.getVersionFast(property.observableField.fieldRecord().semanticVersionStampNid());
