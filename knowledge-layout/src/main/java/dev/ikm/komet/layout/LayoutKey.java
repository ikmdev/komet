...
public sealed interface LayoutKey extends Encodable {
     ...
     * <p>     * It is a canonical representation for scenarios where a "null object" pattern is needed
     ...
     * in the hierarchy.
     * <p>     * This interface is a part of the {@code LayoutKey} hierarchy and permits the {@code LayoutKeyRecord}
     ...
     * <p>     * The {@code LayoutComputer} only allows passing a {@code NextLevel} which must then generate a
     ...
     * <p>     * This sealed interface permits the {@code LayoutKeyRecord} implementation, which
     ...
     * <p>     * This interface is a part of the {@code LayoutKey} hierarchy and is intended to be implemented
     ...
     * <p>     * Implementations of this interface can define mechanisms to extend the layout structure by
     ...
     * <p>     * This sealed interface permits the {@code LayoutKeyRecord}, ensuring a consistent implementation
     ...
     * <p>     * This record serves as the default concrete implementation and fulfills the contracts of the
     * nested {@code Level}, {@code Property}, and {@code NextLevel} sealed interfaces.
     * <p>     * The {@code LayoutKeyRecord} provides mechanisms for:
     ...
     * <p>     * This implementation generates deterministic UUIDs for layout keys using the {@code UuidT5Generator},
