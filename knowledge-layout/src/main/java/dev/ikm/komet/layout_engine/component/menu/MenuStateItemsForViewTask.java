...
public class MenuStateItemsForViewTask implements Callable<MenuItem>, ScopedValue.CallableOp<MenuItem, Exception> {
    @Override
    public MenuItem call() throws Exception {
        ...
        return ViewMenuFactory.makeStateMenu(observableView, "View coordinate", viewCalculator);
    }
}
