...
public class MenuStateItemsForStampTask implements Callable<MenuItem>, ScopedValue.CallableOp<MenuItem, Exception> {
    @Override
    public MenuItem call() throws Exception {
        ...
        return ViewMenuFactory.makeStateMenu(observableView.stampCoordinate(), "Stamp coordinate", viewCalculator);
    }
