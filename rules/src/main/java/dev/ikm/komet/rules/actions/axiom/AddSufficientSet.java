...
public class AddSufficientSet extends AbstractAxiomAction {
    public AddSufficientSet(String text, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator, EditCoordinate editCoordinate) {
