...
public class AddIntervalPropertySet extends AbstractAxiomAction {

	public AddIntervalPropertySet(String text, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator,
