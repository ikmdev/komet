...
public class ChangeRoleType extends ChangeToConceptFromObjectAbstract {

    public ChangeRoleType(String text, Object o, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator, EditCoordinate editCoordinate) {
    ...
    public void doAction(ActionEvent t, ConceptFacade conceptToChangeTo, AxiomSubjectRecord axiomSubjectRecord, EditCoordinateRecord editCoordinate) {
        ...
        switch (leb.get(axiomSubjectRecord.axiomIndex())) {
            case LogicalAxiom.Atom.TypedAtom.Role roleAxiom -> {
                leb.updateRoleType(roleAxiom, conceptToChangeTo);
            }
