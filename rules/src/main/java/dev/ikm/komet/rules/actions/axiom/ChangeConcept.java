...
public class ChangeConcept extends ChangeToConceptFromObjectAbstract {
    public ChangeConcept(String text, Object o, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator, EditCoordinate editCoordinate) {
    ...
    public void doAction(ActionEvent t, ConceptFacade conceptToChangeTo, AxiomSubjectRecord axiomSubjectRecord, EditCoordinateRecord editCoordinate) {
        ...
        switch (leb.get(axiomSubjectRecord.axiomIndex())) {
            case LogicalAxiom.Atom.ConceptAxiom conceptAxiom -> {
                leb.updateConceptReference(conceptAxiom, conceptToChangeTo);
            }
