...
public class ChangeIntervalRoleUnitOfMeasure extends ChangeToConceptFromObjectAbstract {

    public ChangeIntervalRoleUnitOfMeasure(String text, Object o, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator, EditCoordinate editCoordinate) {
    ...
    public void doAction(ActionEvent t, ConceptFacade conceptToChangeTo, AxiomSubjectRecord axiomSubjectRecord, EditCoordinateRecord editCoordinate) {
        ...
        switch (leb.get(axiomSubjectRecord.axiomIndex())) {
            case LogicalAxiom.Atom.TypedAtom.IntervalRole roleAxiom -> {
                leb.updateIntervalRoleUnitOfMeasure(roleAxiom, conceptToChangeTo);
            }
