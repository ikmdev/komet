...
public class AddIntervalRole extends AbstractAxiomAction {
	
	@SuppressWarnings("unused")
	private static final Logger LOG = LoggerFactory.getLogger(AddIntervalRole.class);

	public AddIntervalRole(String text, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator,
