...
public class AddPropertySet extends AbstractAxiomAction {

	public AddPropertySet(String text, AxiomSubjectRecord axiomSubjectRecord, ViewCalculator viewCalculator,
