...
public class PropertiesNode extends ExplorationNodeAbstract {
    ...
    protected static final String STYLE_ID = "amplify-properties-node";
    protected static final String TITLE = "Amplify Properties";
     ...
     * @return PropertiesController The attached controller to the Details view (fxml)
     */
