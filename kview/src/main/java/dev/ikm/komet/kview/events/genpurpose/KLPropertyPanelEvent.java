...
public class KLPropertyPanelEvent extends Evt {
    ...
    public static final EvtType<KLPropertyPanelEvent> SHOW_EDIT_SINGLE_SEMANTIC_FIELD = new EvtType<>(SHOW_EDIT_SEMANTIC_FIELDS, "SHOW_EDIT_SINGLE_SEMANTIC_FIELD");
    public static final EvtType<KLPropertyPanelEvent> SHOW_ADD_REFERENCE_SEMANTIC_FIELD = new EvtType<>(SHOW_PANEL, "SHOW_ADD_REFERENCE_SEMANTIC_FIELD");
