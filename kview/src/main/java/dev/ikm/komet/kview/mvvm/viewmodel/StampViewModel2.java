...
public class StampViewModel2 extends FormViewModel {
     ...
     */
    public static final String CONFIRM_CLEAR_TITLE = "Confirm Reset Form";
    /**
     * Provide the standard Confirm Clear dialog message for use in other classes
     */
    public static final String CONFIRM_CLEAR_MESSAGE =  "Are you sure you want to reset the form? All entered data will be lost.";
