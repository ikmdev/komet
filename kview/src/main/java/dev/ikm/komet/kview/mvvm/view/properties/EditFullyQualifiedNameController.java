...
public class EditFullyQualifiedNameController implements BasicController {
    ...
    private void updateFQN(ActionEvent actionEvent) {
        ...
        // Show FQN added message on submit in properties panel
        eventBus.publish(conceptTopic,
                new EditConceptFullyQualifiedNameEvent(submitButton,
                        EditConceptFullyQualifiedNameEvent.FQN_ADDED, fqnDescrName));
    }
