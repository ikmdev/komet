...
public class KlReadOnlyImageFieldFactory implements KlFieldFactory<byte[]> {
    ...
    public KlField<byte[]> create(ObservableField<byte[]> observableField, ObservableView observableView, ObservableStamp stamp4field) {
        return new KlReadOnlyImageField(observableField, observableView, stamp4field);
    }
    ...
    public Class<? extends KlField<byte[]>> getFieldImplementation() {
        return KlReadOnlyImageField.class;
    }
