...
public class LangEditCoordinateTitledPaneSkin extends TitledPaneSkin {
...
//    private final LangContentBox contentBox;
    private final LangEditCoordinateTitledPane control;
    private Subscription subscription;
    private ScrollPane scrollPane;
//    private EditCoordinateOptions.LanguageFilterCoordinates currentLangCoordinates;

    public LangEditCoordinateTitledPaneSkin(LangEditCoordinateTitledPane control) {
        super(control);
...
//        }
//
//        EditCoordinateOptions.LanguageFilterCoordinates langCoordinates = control.getLangCoordinates();
//
...
//    }
//
//    private void updateModifiedState(EditCoordinateOptions.LanguageFilterCoordinates currentLangCoordinates) {
//        if (control.getOrdinal() != 0) {
//            // modified only applies for the primary language
//            return;
//        }
//        boolean langModified = false;
//        List<EditCoordinateOptions.Option<EntityFacade>> currentOptions = currentLangCoordinates.getOptions();
//        List<EditCoordinateOptions.Option<EntityFacade>> defaultOptions = control.getDefaultLangCoordinates().getOptions();
...
//        // langOptionProperty
//        private final ObjectProperty<EditCoordinateOptions.LanguageFilterCoordinates> langOptionProperty = new SimpleObjectProperty<>(this, "langOption") {
//            @Override
//            protected void invalidated() {
//                EditCoordinateOptions.LanguageFilterCoordinates languageOptions = get();
...
//                            resources.getString("description.option.empty") : String.join(", ", descriptionOptions.stream().map(LangEditCoordinateTitledPaneSkin.this::getDescription).toList()));
...
//            }
//        };
//        public final ObjectProperty<EditCoordinateOptions.LanguageFilterCoordinates> langOptionProperty() {
//            return langOptionProperty;
//        }
//        public final EditCoordinateOptions.LanguageFilterCoordinates getLangOption() {
//            return langOptionProperty.get();
//        }
//        public final void setLangOption(EditCoordinateOptions.LanguageFilterCoordinates value) {
...
//        }
//
//        public EditCoordinateOptions.LanguageFilterCoordinates getLangCoordinates() {
//            EditCoordinateOptions.LanguageFilterCoordinates languageCoordinates = getLangOption().copy();
//
...
//
//        // optionProperty
//        private final ObjectProperty<EditCoordinateOptions.Option<EntityFacade>> optionProperty = new SimpleObjectProperty<>(this, "option") {
//            @Override
//            protected void invalidated() {
//                setupBox(get());
//            }
//        };
//        public final ObjectProperty<EditCoordinateOptions.Option<EntityFacade>> optionProperty() {
//           return optionProperty;
//        }
//        public final EditCoordinateOptions.Option<EntityFacade> getOption() {
//           return optionProperty.get();
//        }
//        public final void setOption(EditCoordinateOptions.Option<EntityFacade> value) {
...
//        }
//
//        private void setupBox(EditCoordinateOptions.Option<EntityFacade> option) {
//            if (lock) {
//                return;
//            }
//            getChildren().clear();
