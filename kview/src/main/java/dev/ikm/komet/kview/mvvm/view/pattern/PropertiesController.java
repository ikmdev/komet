...
import static dev.ikm.komet.kview.mvvm.viewmodel.stamp.StampFormViewModelBase.StampType.PATTERN;
    ...
    private void initialize() {
        ...
        showPatternFormInBumpOutEventSubscriber = evt -> {
            ...
            if (evt.getEventType() == SHOW_ADD_DEFINITION || evt.getEventType() == SHOW_EDIT_DEFINITION) {
                ...
                confirmationPaneViewModel.setPropertyValue(CONFIRMATION_TITLE, "Continue Editing Fields?");
        ...
        showPropertyPanelSubscriber = evt -> {
            ...
            if (evt.getEventType() == DEFINITION_CONFIRMATION) {
                ...
                confirmationPaneViewModel.setPropertyValue(CONFIRMATION_TITLE, "Definition Added");
                confirmationPaneViewModel.setPropertyValue(CONFIRMATION_MESSAGE, "");
            }
            patternViewModel.save();
        };
