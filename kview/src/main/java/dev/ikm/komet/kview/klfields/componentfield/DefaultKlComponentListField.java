...
public class DefaultKlComponentListField extends BaseDefaultKlField<List<EntityProxy>> implements KlComponentListField {

    public DefaultKlComponentListField(ObservableField<List<EntityProxy>> observableComponentListField, ObservableView observableView, boolean isEditable) {
        super(observableComponentListField, observableView, isEditable);
        Node node;
        ObjectProperty<List<EntityProxy>> observablePropertyList = observableComponentListField.valueProperty();
