...
public enum CursorMappings {
    ...
    static {
        ...
        RESIZE_HANDLERS.put(ResizeDirection.NW, (ws, e) -> { ws.resizeNorth(e); ws.resizeWest(e); });
        RESIZE_HANDLERS.put(ResizeDirection.N, WindowSupport::resizeNorth);
        RESIZE_HANDLERS.put(ResizeDirection.NE, (ws, e) -> { ws.resizeNorth(e); ws.resizeEast(e); });
        RESIZE_HANDLERS.put(ResizeDirection.E, WindowSupport::resizeEast);
        RESIZE_HANDLERS.put(ResizeDirection.SE, (ws, e) -> { ws.resizeSouth(e); ws.resizeEast(e); });
        RESIZE_HANDLERS.put(ResizeDirection.S, WindowSupport::resizeSouth);
        RESIZE_HANDLERS.put(ResizeDirection.SW, (ws, e) -> { ws.resizeSouth(e); ws.resizeWest(e); });
