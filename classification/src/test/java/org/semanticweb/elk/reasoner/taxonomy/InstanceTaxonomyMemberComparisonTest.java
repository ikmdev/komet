...
public class InstanceTaxonomyMemberComparisonTest {
	...
	static interface InstanceTaxonomyProvider {
		InstanceTaxonomy<ElkClass, ElkNamedIndividual> getTaxonomy(
				String resource) throws ElkException;
	}
	...
	static class Manifest implements TestManifest<TestInput> {
		...
		public String getName() {
			return instanceTaxonomyProvider.toString();
		}
	...
	public InstanceTaxonomyMemberComparisonTest(final Manifest manifest) {
	...
	public void testNodeLookup() throws ElkException {
		final InstanceTaxonomy<ElkClass, ElkNamedIndividual> taxonomy = instanceTaxonomyProvider_
				.getTaxonomy(
						"taxonomy_member_comparison/instance_node_lookup.owl");
		...
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeSameA1 = taxonomy
				.getInstanceNode(sameA1);
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeSameA2 = taxonomy
				.getInstanceNode(sameA2);
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeSameA3 = taxonomy
				.getInstanceNode(sameA3);
		...
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeDifferentA1 = taxonomy
				.getInstanceNode(differentA1);
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeDifferentA2 = taxonomy
				.getInstanceNode(differentA2);
		...
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeSameC1 = taxonomy
				.getInstanceNode(sameC1);
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeSameC2 = taxonomy
				.getInstanceNode(sameC2);
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeSameC3 = taxonomy
				.getInstanceNode(sameC3);
	...
	public void testRelatedNodes() throws ElkException {
		final InstanceTaxonomy<ElkClass, ElkNamedIndividual> taxonomy = instanceTaxonomyProvider_
				.getTaxonomy(
						"taxonomy_member_comparison/instance_related_nodes.owl");
		...
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeDifferentA = taxonomy
				.getInstanceNode(differentA2);
		...
		final InstanceNode<ElkClass, ElkNamedIndividual> nodeSameA = taxonomy
				.getInstanceNode(sameA2);
		...
		final TypeNode<ElkClass, ElkNamedIndividual> nodeB = taxonomy
				.getNode(differentB2);
		...
		final TypeNode<ElkClass, ElkNamedIndividual> nodeC = taxonomy
				.getNode(differentC2);
