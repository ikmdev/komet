...
/**
 * An {@link ElkSubObjectPropertyOfAxiomConversion} that can be modified as a
 * result of updating the {@link ModifiableOntologyIndex} where this object is
 * stored.
 * 
 * @author "Yevgeny Kazakov"
 */
public interface ModifiableElkSubObjectPropertyOfAxiomConversion
		extends ElkSubObjectPropertyOfAxiomConversion,
	...
	interface Visitor<O> {
		...
		O visit(ModifiableElkSubObjectPropertyOfAxiomConversion inference);
